        ...
        {query.map((q, index) => (
            <div className="container mx-auto" key={index}>
              <div className='flex items-center justify-center pb-4'>
                ...
                <h1 className='text-5xl text-center text-accent-1'> {q.coingecko_rank}. {q.name} </h1>
                <img src={q.image.small} alt='Coin Image' />
                <br/>
              ...
              <div className="flex text-xl items-center space-x-4">
                ...
                <p className="text-green-600 text-center"> {q.sentiment_votes_up_percentage}</p>
                ...
                <p className="text-red-600 text4-center"> {q.sentiment_votes_down_percentage}</p>
                <svg xmlns="http://www.w3.org/2000/svg" height='14px' width='14px' className='self-center' viewBox="0 0 20 20">
              ...
              <br />
              <p className="" dangerouslySetInnerHTML={{__html: q.description.en}}></p>
            </div>
        ))}
    </div>
  )
